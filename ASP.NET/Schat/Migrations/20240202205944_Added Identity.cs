    ...
    public partial class AddedIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__user__3213E83F6EC9DBD4", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__message__3213E83F9345AA1A", x => x.id);
                    table.ForeignKey(
                        name: "FK__message__from__09A971A2",
                        column: x => x.from,
                        principalSchema: "schat",
                        principalTable: "user",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK__message__to__0A9D95DB",
                        column: x => x.to,
                        principalSchema: "schat",
                        principalTable: "user",
                        principalColumn: "id");
